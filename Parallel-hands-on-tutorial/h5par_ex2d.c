/* HDF5 Dataset example, collective metadata modification and early space allocation */
...
printf("my rank = %d (%d)\n", mpi_rank, mpi_size);
    ...
    for(i = 0; i < mpi_size; i++) {
        ...
        /* Every process participates in each group creation */
        sprintf(groupname, "Group_%d", i);
        ...
        /* Close dataset craetion propery */
